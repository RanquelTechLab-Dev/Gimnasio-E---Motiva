-- RAN-34: calendar final-date handling, admin historical bookings, and
-- Neurofuncional free booking/cancellation cutoffs.
--
-- Safety:
-- - No rows are deleted.
-- - Student-facing booking/cancellation RPCs keep their time rules.
-- - Admin booking by student still requires active student, active paid program,
--   matching activity, capacity, and weekly/package availability.
